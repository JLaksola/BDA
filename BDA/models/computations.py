...
plt.figure(figsize=(12, 5))
plt.subplot(3, 1, 1)
plt.plot(shiller_df.index, shiller_df["Inflation"], color="blue")
plt.title("Year-over-Year Inflation Over Time")
plt.xlabel("Date")
plt.ylabel("Inflation (%)")
plt.grid()
plt.subplot(3, 1, 2)
plt.plot(shiller_df.index, shiller_df["GS10"], color="green")
...
plt.grid()
plt.subplot(3, 1, 3)
plt.plot(shiller_df.index, shiller_df["CAPE"], color="orange")
